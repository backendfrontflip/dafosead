...
const Footer = () => {
  return (
    <footer className="bg-red-600 text-gray-300 py-12 mt-20">
      <div className="max-w-7xl mx-auto px-6 md:px-20 grid grid-cols-1 md:grid-cols-3 gap-10">
        {/* Company Info */}
        <div>
          <div>
            <h2 className="text-2xl font-bold text-gray-300">DAFOSEAD</h2>
            <span className='text-sm'>Technical Co Limited</span>
          </div>
        ...
        <div>
          ...
          <ul className="text-sm space-y-2 mb-4">
            <li>Email: <a href="mailto:info@beltco.ng" className="hover:text-white">info@dafoseadtechnicalcolimited</a></li>
          ...
          <div className="flex space-x-4 mt-4 text-xl">
            ...
            <a href="mailto:info@beltco.ng" className="hover:text-white transition">
              <FaEnvelope />
            </a>
